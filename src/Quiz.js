...
const Quiz = () => {
  ...
  return (
    ...
    <div className="h-screen flex flex-col justify-center items-center font-title">
      <div id="header" class="w-full h-16 max-w-md bg-primary-400 flex justify-center items-center text-md text-white">
      갓물주 운명 테스트
      </div>
      {shuffledQuestions[currentQuestion] ? (
        <div className="flex flex-col h-full max-w-md w-full bg-gray-100 py-20 px-8 font-title gap-1">
          ...
          {/* 질문 번호 */}
          <div className="text-2xl text-center mb-2.5">{`Q${currentQuestion + 1}`}</div>


          {/* 상단 질문 영역 */}
          <div className="text-center text-2xl whitespace-pre-line">
