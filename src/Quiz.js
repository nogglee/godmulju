...
const Quiz = () => {
  ...
  const questions = [
    ...
    { text: '건물 관리 회의가 잡혔다. 첫 회의를 위해,', options: [{ text: '회의 전 모든 자료를 꼼꼼하게 준비해서 정리해가야겠다!', type: 'I' }, { text: '적극적으로 의견 어필해서 분위기를 휘어잡을거야!', type: 'E' }] },
    ...
    { text: '월세 입금이 아직 안들어와있다. 당신의 반응은?', options: [{ text: '이럴 줄 알았어 알림 설정해놓길 잘했네 연락해봐야지', type: 'J' }, { text: '깜빡했을수도 있어 며칠 더 기다려봐야지', type: 'P' }] },
  ];
